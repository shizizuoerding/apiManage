...
var Nihao_ceshi = AV.Object.extend('Nihao_ceshi');
...
router.get('/delete', function(req, res, next) {
	...
	var delObj = AV.Object.createWithoutData('Nihao_ceshi', data.id);
...
router.post('/edit', function(req, res, next) {
	...
	var editObj = AV.Object.createWithoutData('Nihao_ceshi', data.id);
	for(var key in data){
...
router.get('/list', function(req, res, next) {
	...
	var query = new AV.Query('Nihao_ceshi');
	query.skip(skip);
	query.limit(limit);
	if(data.asc){
