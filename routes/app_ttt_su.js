...
var App_ttt_su = AV.Object.extend('App_ttt_su');
...
router.get('/delete', function(req, res, next) {
	...
	var delObj = AV.Object.createWithoutData('App_ttt_su', data.id);
...
router.post('/edit', function(req, res, next) {
	...
	var editObj = AV.Object.createWithoutData('App_ttt_su', data.id);
	for(var key in data){
...
router.get('/list', function(req, res, next) {
	...
	var query = new AV.Query('App_ttt_su');
	query.skip(skip);
	query.limit(limit);
	if(data.asc){
