...
var Test_app_grade = AV.Object.extend('Test_app_grade');
...
router.get('/delete', function(req, res, next) {
	...
	var delObj = AV.Object.createWithoutData('Test_app_grade', data.id);
...
router.post('/edit', function(req, res, next) {
	...
	var editObj = AV.Object.createWithoutData('Test_app_grade', data.id);
	for(var key in data){
...
router.get('/list', function(req, res, next) {
	...
	var query = new AV.Query('Test_app_grade');
	query.skip(skip);
	query.limit(limit);
	if(data.asc){
...
if(AS.config.APPID)
AS.build('/test_app_grade',router);
