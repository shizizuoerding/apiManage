...
var Nihao_ceshi2 = AV.Object.extend('Nihao_ceshi2');
...
router.get('/delete', function(req, res, next) {
	...
	var delObj = AV.Object.createWithoutData('Nihao_ceshi2', data.id);
...
router.post('/edit', function(req, res, next) {
	...
	var editObj = AV.Object.createWithoutData('Nihao_ceshi2', data.id);
	for(var key in data){
...
router.get('/list', function(req, res, next) {
	...
	var query = new AV.Query('Nihao_ceshi2');
	query.skip(skip);
	query.limit(limit);
	if(data.asc){
