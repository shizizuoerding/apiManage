...
var Nihao_user = AV.Object.extend('Nihao_user');
...
router.get('/delete', function(req, res, next) {
	...
	var delObj = AV.Object.createWithoutData('Nihao_user', data.id);
...
router.post('/edit', function(req, res, next) {
	...
	var editObj = AV.Object.createWithoutData('Nihao_user', data.id);
	for(var key in data){
...
router.get('/list', function(req, res, next) {
	...
	var query = new AV.Query('Nihao_user');
	query.skip(skip);
	query.limit(limit);
	if(data.asc){
